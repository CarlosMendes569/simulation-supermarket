...
The project was developed in three phases:
  	...
  	- Phase 1 – Current System Simulation

	A discrete-event simulation model was built and validated to represent the supermarket's current checkout operation. Historical data was analyzed to model customer arrivals, shopping durations and checkout service times.

	- Phase 2 – Scenario Analysis

	Alternative workforce schedules were implemented and compared against the current system to evaluate their impact on operational performance and customer service.
...
This project demonstrates how simulation and optimization techniques can support data-driven workforce planning decisions by balancing operational efficiency, labor costs and customer satisfaction.